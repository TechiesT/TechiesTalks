...
def article_details(request,slug):
    ...
    meta=post.as_meta()
    a = ' - TechiesTalks'
    return render(request,'articles/article_details.html',{'a':a, 'meta':meta,'post_tags_ids':post_tags_ids,'articles':post,'tag': tag, 'categories':categories,'post':post,'comments':comments,'similar_posts':similar_posts,'comment_form':comment_form,'reply':comment_qs,'is_liked':is_liked,'total_likes':post.total_likes(),})
